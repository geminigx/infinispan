...
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.EVICTED;
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.REMOVED;
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.COPIED;
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.CHANGED;
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.CREATED;
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.VALID;
...
public abstract class OffHeapReadCommittedEntry implements OffHeapMVCCEntry {
   ...
   public boolean isLoaded() {
      return isFlagSet(OffHeapReadCommittedEntry.Flags.LOADED);
   }

   @Override
   public void setLoaded(boolean loaded) {
      setFlag(loaded, OffHeapReadCommittedEntry.Flags.LOADED);
   }
