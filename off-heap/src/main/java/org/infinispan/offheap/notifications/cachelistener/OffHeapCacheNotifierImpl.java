 ...
 * @since 4.0
 */
public final class OffHeapCacheNotifierImpl extends AbstractListenerImpl implements ClusterCacheNotifier {

   private static final Log log = LogFactory.getLog(OffHeapCacheNotifierImpl.class);
   ...
   public OffHeapCacheNotifierImpl() {
