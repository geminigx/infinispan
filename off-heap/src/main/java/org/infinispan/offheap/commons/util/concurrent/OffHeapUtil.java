package org.infinispan.offheap.commons.util.concurrent;
 ...
 * @since 4.0
 */
public final class OffHeapUtil {
   ...
   private static final Log log = LogFactory.getLog(OffHeapUtil.class);
    ...
    * {@link org.infinispan.commons.CacheConfigurationException} and is re-thrown.
    * </p>
    *
    ...
    *        Infinispan
    * @return the class
    * @throws org.infinispan.commons.CacheConfigurationException if the class cannot be loaded
    */
   ...
   public static ClassLoader[] getClassLoaders(ClassLoader appClassLoader) {
      return new ClassLoader[] {
            ...
            OffHeapUtil.class.getClassLoader(), // Infinispan classes (not always on TCCL [modular env])
    ...
    * <p/>
    * Any exceptions encountered are wrapped in a {@link org.infinispan.commons.CacheConfigurationException} and rethrown.
    *
    ...
    * <p />
    * Any exceptions encountered loading and instantiating the class is wrapped in a {@link org.infinispan.commons.CacheConfigurationException}.
    *
